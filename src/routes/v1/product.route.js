...
router.route('/seller/:sellerId').get(auth('manageProducts'), productController.getProductsBySellerId);
 ...
 *     description: Only admins or sellers can create other products.
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Fetch product by productId
 *     tags: [Products]
 *     parameters:
 *       - in: path
 *         name: productId
