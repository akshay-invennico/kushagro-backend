...
const getOrderPlacedEmailTemplate = (orderId, customerName, items, totalAmount) => {
  ...
  const content = `
    ...
    <p>Thank you for your order! We're excited to let you know that we've received your order.</p>
...
module.exports = getOrderPlacedEmailTemplate;
